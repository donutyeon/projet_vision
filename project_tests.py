...
def encode(image_name, secret_data):
    ...
    n_bytes_test = image_rgb.shape[0] * image_rgb.shape[1] * 3 // 16
    print((n_bytes_test))
    ...
    binary_secret_data = to_bin(secret_data,"08b")
    ...
    #         #     data_index += 1
            if data_index < data_len:
                ...
                print(Cb[-1],binary_secret_data[data_index],Cb[:-1] + binary_secret_data[data_index])
...
def decode(image_name):
    ...
    #print("error")
    print(binary_data)
    all_bytes = [binary_data[i] for i in range(0, len(binary_data), 1)]
    #print(all_bytes)
